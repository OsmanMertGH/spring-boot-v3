...
public class SchoolController {
    ...
    public ResponseEntity<ResponseWrapper> readAllParents() {
        ResponseWrapper responseWrapper = new ResponseWrapper(true, "Parents are retrieved succesfully", HttpStatus.OK.value(), parentService.findAll());
    ...
    public ResponseEntity<ResponseWrapper> getAddress(@PathVariable("id") Long id) throws Exception {
        ...
        return ResponseEntity.ok(new ResponseWrapper("Adress is succesfully retrieved", addressDTO));
    }
